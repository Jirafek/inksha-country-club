         ...
         <div className='absolute inset-0 z-10 flex '>
            ...
            <div className='relative w-full h-full'>
               <Reveal duration={1} variants={slideFromLeft()}>
                  <div className='text-white w-[95vw] text-center rounded-[20px] md:w-auto absolute transform left-1/2 -translate-x-1/2 top-[80px] font-extrabold text-xl text-nowrap bg-[#4D382B] bg-opacity-80 p-5'>
