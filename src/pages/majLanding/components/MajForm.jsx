         ...
         <div className="w-full flex  justify-center md:justify-end ">
            ...
            >
               ...
               <input
                  type="text"
                  placeholder="Имя"
                  className="mb-5 border border-MajGreen h-[40px] pl-[25px] md:pl-[50px] md:h-[80px] w-[100%] md:w-full rounded-[20px] bg-white p-2 text-[14px] text-black outline-none md:text-[27px]"
               ...
               >
                  {(inputProps) => (
                     <input
                        type="text"
                        placeholder="Телефон"
                        className={`mb-5 border border-MajGreen h-[40px] pl-[25px] md:pl-[50px]  md:h-[80px] w-[100%] md:w-full rounded-[20px] bg-white p-2 text-[14px] text-black outline-none md:text-[27px] ${phoneError ? "border-red-500" : ""
                           }`}
                        {...inputProps}
                     />
                  )}
               ...
               <Button
                  ...
                  className="mx-auto h-[40px] w-full md:h-[60px] montserrat bg-MajGreen gap-10 md:w-full   text-white shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]"
               >
                  Узнать стоимость
               </Button>
            </form>
