               ...
               <div key={uuidv4()} className="flex flex-col items-center">
                  ...
                  <div className="flex flex-col items-center gap-1">
                     ...
                     <a
                        ...
                        // }}
                        className=" montery border-1 flex min-h-[32px] min-w-[160px] cursor-pointer items-center justify-center gap-1 rounded-[20px] border border-[#433E6A] bg-[#79E718] px-[20px] py-[7px] text-[19px] font-[600] shadow-2xl duration-300 hover:opacity-30"
                     >
                        Подробнее
                     </a>
                  </div>
