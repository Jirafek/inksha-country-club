...
const ButterServices = () => {
   ...
   return (
      <div id='services' className='relative py-[40px] wrapper text-white  '>
         <div>
                  ...
                  return (
                     <div key={i} className={`justify-between ${s.services_wrapper} w-full gap-2 md:gap-4 items-center py-[10px] md:py-[50px] flex`}>
                        <div className='flex flex-col'>
                           <div className="text-white text-md leading-[33.80px] tracking-wide">{item.title}</div>

                           <div className="text-zinc-500 text-md- leading-relaxed tracking-tight">{item.description}</div>
                        </div>
                        <div className="text-white text-md montserrat text-right leading-[33.80px] tracking-wide">{item.price}</div>
                     </div>
                  )
               })}
            </div>
         ...
         <div className='text-center w-full mt-[5vh]'>
            ...
            <a className="text-white mx-auto font-bold text-md text-center underline" target='_blank' href="/pdf/priceList.pdf">Прайс лист</a>
