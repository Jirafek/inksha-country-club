...
const ManModule = () => {
   useEffect(() => {
      ...
      const initializeWidget = () => {
         ...
         const customStyles = `
         #module > div > div:nth-child(1) > div > div > div > div.znms-widget__module-form-block__items > div.znms-widget__module-form-block__title.znms-widget__module-form-block__items__item.znms-widget__module-form-block__title--inline{
            color:#002500;
         }
