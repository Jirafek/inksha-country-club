    ...
    return (
        <section style={{ backgroundImage: 'url(/image/faq_bg.webp)' }} className="relative back_settings h-[851px]">
            <div className="flex flex-col items-center justify-center relative h-[90px] z-10">
                <img className="absolute" src="/image/titles_bg.webp" alt="Загородный клуб Икша Кантри Клаб Подмоковье" />
            ...
            <div className="flex justify-center flex-col items-center gap-2">
                {
                    faq_data.map((el, i) => (
                        <div className="flex items-center">
                            <img onClick={() => handleQuestionClick(i)} src="/image/faq_plus.webp" alt="Отдых в Подмосковье" />
