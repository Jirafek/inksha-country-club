...
import longarrow from "icons/longgreenarrow.png"

// import arrow from "icons/arrow.png"

import { Link } from "react-router-dom"
import MartModule from './MajModule'
import { getLocation } from 'constants/locations'
import s from './../maj.module.scss'

const MajLocations = () => {
   return (
      <div id="locations" className="bg-MajOrange text-black ">
                  ...
                  return (
                     ...
                     >
                        ...
                        <div className="flex flex-col justify-between    py-[20px]">
                           <div className={`text-md  max-w-[150px] font-bold text-MajGreen `}>
                              {loc.title}
                           </div>
                           <div className="flex items-center  gap-5 text-sm font-semibold text-white">
                              <div className="flex flex-col text-MajGreen gap-2">
