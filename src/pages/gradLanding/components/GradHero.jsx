...
const GradHero = () => {
   ...
   return (
      <div id="Hero" className=' bg-GradOrange '>
         <div className={`relative  text-black `}>
            <div className={`relative flex-col-reverse md:flex-row flex md:pr-[80px] h-screen ${s.heroBg} w-full items-center justify-center `}>
               ...
               <div className={`w-full max-w-[900px] translate absolute transform -translate-y-1/2 top-1/2 -translate-x-1/2 left-1/2 rounded-[10px] px-[30px] md:px-[70px] py-[30px]  bg-GradCyan  bg-opacity-50 z-10 flex-col text-center flex items-center `}>
                  <Reveal delay={0.25}>
                     <div className={`relative`}>
                        <div className={` text-GradPurple text-xl font-bold`}>
                           ВЫПУСКНОЙ ВЕЧЕР
                        </div>
                     </div>
                  </Reveal>
                  ...
                  <Reveal delay={0.25}>
                     <div className={`text-white  font-[500] text-md+ `}>
                        Лучшая площадка для твоего выпускного на берегу Икшинского водохранилища!
                        Отметь свой незабываемый выпускной в <span className='font-bold'>Икша Кантри Клаб!</span>
                     </div>
                  </Reveal>


                  <Button href="#form" className="bg-BirthPurple text-white text-md+ w-full h-[50px]">Отпраздновать выпускной в Икша Кантри Клаб</Button>
         ...
         {/* <div className='bg-[#F5DDC3]'>
            ...
            <Reveal delay={0.5}>
               <div className={`text-md+  ${s.dudkaReg} max-w-[1200px]  text-GradGreen text-center py-[10vh] rounded-[20px] mx-[20px] md:mx-auto font-semibold`}>
