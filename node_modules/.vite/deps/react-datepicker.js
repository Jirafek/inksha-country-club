...
import {
  ...
  toDate,
  toInteger
} from "./chunk-D4BHMQMO.js";
import {
  require_prop_types
} from "./chunk-4HDPYLGE.js";
import "./chunk-FXIKXRN7.js";
import {
  createPopper2 as createPopper
} from "./chunk-PL2NLS5O.js";
import "./chunk-E6JLXJIM.js";
import {
  require_classnames
} from "./chunk-JZT4IH44.js";
import {
  require_react_dom
...
function ue(e2) {
  return ue = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(e3) {
    return typeof e3;
  } : function(e3) {
...
function _e(e2) {
  ...
  return typeof t2 == "symbol" ? t2 : String(t2);
}
...
function at(e2) {
  var t2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, r2 = t2.minDate, n = t2.maxDate, o = t2.excludeDates, a = t2.includeDates, s = t2.filterDate, i = new Date(e2, 0, 1);
...
function wt(e2) {
  var t2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Ne, r2 = Math.ceil(getYear(e2) / t2) * t2;
...
var xt = function(t2) {
  ...
  function o() {
    ...
    return ve(ke(t3 = n.call.apply(n, [this].concat(s))), "dayEl", import_react2.default.createRef()), ve(ke(t3), "handleClick", function(e2) {
      ...
      if (!t3.isInSelectingRange())
        return false;
      var r2 = t3.props, n2 = r2.day, o2 = r2.endDate, a2 = r2.selectsEnd, s2 = r2.selectsRange, i2 = (e2 = t3.props.selectingDate) !== null && e2 !== void 0 ? e2 : t3.props.preSelection;
...
var At = function(t2) {
  ...
  function o() {
    ...
    return ve(ke(t3 = n.call.apply(n, [this].concat(s))), "MONTH_REFS", Se(Array(12)).map(function() {
      ...
      var r2, n2 = t3.props, o2 = n2.day, a2 = n2.selectsStart, s2 = n2.selectsEnd, i2 = n2.selectsRange, p = n2.startDate, c = n2.endDate, l = (r2 = t3.props.selectingDate) !== null && r2 !== void 0 ? r2 : t3.props.preSelection;
      ...
      if (!t3.isInSelectingRangeMonth(e2))
        return false;
      var n2 = t3.props, o2 = n2.day, a2 = n2.startDate, s2 = n2.selectsStart, i2 = setMonth(o2, e2), p = (r2 = t3.props.selectingDate) !== null && r2 !== void 0 ? r2 : t3.props.preSelection;
      return We(i2, s2 ? p : a2);
    }), ve(ke(t3), "isSelectingMonthRangeEnd", function(e2) {
      var r2;
      if (!t3.isInSelectingRangeMonth(e2))
        return false;
      var n2 = t3.props, o2 = n2.day, a2 = n2.endDate, s2 = n2.selectsEnd, i2 = n2.selectsRange, p = setMonth(o2, e2), c = (r2 = t3.props.selectingDate) !== null && r2 !== void 0 ? r2 : t3.props.preSelection;
      ...
      if (d !== "Tab" && e2.preventDefault(), !s2) {
        ...
        switch (d) {
          case "Enter":
            ...
            break;
          case "ArrowRight":
            t3.handleMonthNavigation(r2 === 11 ? 0 : r2 + 1, addMonths(a2, 1));
            break;
          case "ArrowLeft":
            t3.handleMonthNavigation(r2 === 0 ? 11 : r2 - 1, subMonths(a2, 1));
            break;
          case "ArrowUp":
      ...
      if (!t3.props.disabledKeyboardNavigation)
        switch (n2) {
          case "Enter":
            ...
            break;
          case "ArrowRight":
            t3.handleQuarterNavigation(r2 === 4 ? 1 : r2 + 1, addQuarters(t3.props.preSelection, 1));
            break;
          case "ArrowLeft":
            t3.handleQuarterNavigation(r2 === 1 ? 4 : r2 - 1, subQuarters(t3.props.preSelection, 1));
        }
...
var Bt = function(t2) {
  ...
  function o(t3) {
    ...
    return he(this, o), ve(ke(a = n.call(this, t3)), "YEAR_REFS", Se(Array(a.props.yearItemNumber)).map(function() {
      ...
      var e2;
      return (e2 = a.props.selectingDate) !== null && e2 !== void 0 ? e2 : a.props.preSelection;
...
var Ht = function(t2) {
  ...
  function o(t3) {
    ...
    return he(this, o), ve(ke(a = n.call(this, t3)), "handleClickOutside", function(e2) {
      ...
      var t4 = Le(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : a.state.date, a.props.locale, a.props.calendarStartDay), n2 = [];
      ...
      if (!a.props.renderCustomHeader) {
        ...
        switch (true) {
          ...
          case a.props.showYearPicker:
            t4 = function(e2) {
              var t5 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, r3 = t5.minDate, n3 = t5.yearItemNumber, o3 = n3 === void 0 ? Ne : n3, a2 = wt(Ae(subYears(e2, o3)), o3).endPeriod, s2 = r3 && getYear(r3);
      ...
      if (!a.props.renderCustomHeader) {
        ...
        switch (true) {
          ...
          case a.props.showYearPicker:
            t4 = function(e2) {
              var t5 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, r3 = t5.maxDate, n3 = t5.yearItemNumber, o3 = n3 === void 0 ? Ne : n3, a2 = wt(addYears(e2, o3), o3).startPeriod, s2 = r3 && getYear(r3);
              return s2 && s2 < a2 || false;
            }(a.state.date, a.props);
            break;
          default:
        ...
        if ((a.props.forceShowMonthNavigation || a.props.showDisabledMonthNavigation || !t4) && !a.props.showTimeSelectOnly) {
          ...
          var o2 = a.props.showMonthYearPicker || a.props.showQuarterYearPicker || a.props.showYearPicker, s = a.props, i = s.nextMonthButtonLabel, p = s.nextYearButtonLabel, c = a.props, l = c.nextMonthAriaLabel, d = l === void 0 ? typeof i == "string" ? i : "Next Month" : l, h = c.nextYearAriaLabel, m = h === void 0 ? typeof p == "string" ? p : "Next Year" : h;
...
var Xt = function(t2) {
  ...
  function a(t3) {
    ...
    return he(this, a), ve(ke(s = o.call(this, t3)), "getPreSelection", function() {
      ...
      return { open: s.props.startOpen || false, preventFocus: false, preSelection: (e2 = s.props.selectsRange ? s.props.startDate : s.props.selected) !== null && e2 !== void 0 ? e2 : o2, highlightDates: yt(s.props.highlightDates), focused: false, shouldFocusDayInline: false, isRenderAriaLiveMessage: false };
      ...
      for (var e2 = arguments.length, t4 = new Array(e2), r2 = 0; r2 < e2; r2++)
        t4[r2] = arguments[r2];
      var n = t4[0];
      if (!s.props.onChangeRaw || (s.props.onChangeRaw.apply(ke(s), t4), typeof n.isDefaultPrevented == "function" && !n.isDefaultPrevented())) {
        ...
        var o2, a2, i, p, c, l, d, u, h = (o2 = n.target.value, a2 = s.props.dateFormat, i = s.props.locale, p = s.props.strictParsing, c = s.props.minDate, l = null, d = Ge(i) || Ge($e()), u = true, Array.isArray(a2) ? (a2.forEach(function(e3) {
          var t5 = parse(o2, e3, new Date(), { locale: d });
          p && (u = Ie(t5, c) && o2 === Oe(t5, e3, i)), Ie(t5, c) && u && (l = t5);
        }), l) : (l = parse(o2, a2, new Date(), { locale: d }), p ? u = Ie(l) && o2 === Oe(l, a2, i) : Ie(l) || (a2 = a2.match(xe).map(function(e3) {
          var t5 = e3[0];
          return t5 === "p" || t5 === "P" ? d ? (0, Pe[t5])(e3, d.formatLong) : t5 : e3;
        }).join(""), o2.length > 0 && (l = parse(o2, a2.slice(0, o2.length), new Date())), Ie(l) || (l = new Date(o2))), Ie(l) && u ? l : null));
        s.props.showTimeSelectOnly && s.props.selected && !He(h, s.props.selected) && (h = set(s.props.selected, h == null ? { hours: getHours(s.props.selected), minutes: getMinutes(s.props.selected), seconds: getSeconds(s.props.selected) } : { hours: getHours(h), minutes: getMinutes(h), seconds: getSeconds(h) })), !h && n.target.value || s.setSelected(h, n, true);
      }
      ...
      if (s.props.showYearPicker) {
        if (o2 !== null && at(getYear(o2), s.props))
          return;
      } else if (s.props.showMonthYearPicker) {
        if (o2 !== null && tt(o2, s.props))
          return;
      } else if (o2 !== null && Ze(o2, s.props))
        return;
      ...
      if (!Ve(s.props.selected, o2) || s.props.allowSameDay || p)
        if (o2 !== null && (!s.props.selected || r2 && (s.props.showTimeSelect || s.props.showTimeSelectOnly || s.props.showTimeInput) || (o2 = Re(o2, { hour: getHours(s.props.selected), minute: getMinutes(s.props.selected), second: getSeconds(s.props.selected) })), s.props.inline || s.setState({ preSelection: o2 }), s.props.focusSelectedMonth || s.setState({ monthSelectedIn: n })), p) {
          var d = c && !l, u = c && l;
      ...
      if (s.state.open || s.props.inline || s.props.preventOpenOnFocus) {
        if (s.state.open) {
          ...
          t4 === "Enter" ? (e2.preventDefault(), s.inputOk() && s.state.lastPreSelectChange === er ? (s.handleSelect(n, e2), !s.props.shouldCloseOnSelect && s.setPreSelection(n)) : s.setOpen(false)) : t4 === "Escape" ? (e2.preventDefault(), s.setOpen(false)) : t4 === "Tab" && e2.shiftKey && s.setOpen(false), s.inputOk() || s.props.onInputError({ code: 1, msg: Jt });
        }
      } else
      ...
      var t4, n = (0, import_classnames.default)(s.props.className, ve({}, $t, s.state.open)), o2 = s.props.customInput || import_react2.default.createElement("input", { type: "text" }), a2 = s.props.customInputRef || "ref", i = typeof s.props.value == "string" ? s.props.value : typeof s.state.inputValue == "string" ? s.state.inputValue : s.props.selectsRange ? function(e2, t5, r2) {
        if (!e2)
          return "";
  ...
  return fe(a, [{ key: "componentDidMount", value: function() {
    ...
    var r2, n;
    e2.inline && (r2 = e2.selected, n = this.props.selected, r2 && n ? getMonth(r2) !== getMonth(n) || getYear(r2) !== getYear(n) : r2 !== n) && this.setPreSelection(this.props.selected), this.state.monthSelectedIn !== void 0 && e2.monthsShown !== this.props.monthsShown && this.setState({ monthSelectedIn: 0 }), e2.highlightDates !== this.props.highlightDates && this.setState({ highlightDates: yt(this.props.highlightDates) }), t3.focused || Ve(e2.selected, this.props.selected) || this.setState({ inputValue: null }), t3.open !== this.state.open && (t3.open === false && this.state.open === true && this.props.onCalendarOpen(), t3.open === true && this.state.open === false && this.props.onCalendarClose());
  } }, { key: "componentWillUnmount", value: function() {
