            ...
            <div className="wrapper py-[8vh]">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <div className="flex flex-col  justify-center gap-10">
                     ...
                     <div className={` ${s.kaytering_blockBg} text-white flex flex-col justify-center items-center h-[200px] rounded-[22px] p-5`}>
                        <div className="text-md font-[600] text-white text-center">
                           {t('kayt.selectDishes')}
                        </div>
                        <Button
                           onClick={toggleMenu}
                           className="bg-white  montserrat mt-4 text-md  h-[60px] text-black w-full"
                        >
                           {t('kayt.viewMenu')}
                        </Button>
                     </div>
