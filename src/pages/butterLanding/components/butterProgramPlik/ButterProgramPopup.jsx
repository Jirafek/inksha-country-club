...
const MartProgramPopup = ({ onClose }) => {
   const infos = GetInfo()
   ...
   return (
      <div className={`fixed bg-white transform top-1/2 -translate-y-1/2 border overflow-y-auto border-MartPurple rounded-[10px] -translate-x-1/2 left-1/2 z-[10000000]  acariMedium w-[90vw] max-h-[95vh] md:h-auto md:min-w-[700px] lg:min-w-[1000px] md:w-auto flex justify-center   text-MartPurple`}>
         <div className='px-[20px] md:px-[100px] py-[50px] md:py-[40px] text-center'>
            <div className={`text-MartPurple ${s.rosarium} font-medium mb-[10px] text-[30px] md:text-lg`}>{info.title}</div>
            ...
            <div className="items-center sm:justify-start justify-center mb-[20px] gap-5 flex-col sm:flex-row flex">
               <div onClick={onClose} className=" cursor-pointer flex items-center gap-2 h-3 ">
                  ...
                  <div className="text-MartPurple font-medium  leading-snug">Вернуться назад</div>
               </div>
...
export default MartProgramPopup