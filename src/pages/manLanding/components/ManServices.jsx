   ...
   return (
      <div id='services' className='relative py-[40px] wrapper text-white  '>
         ...
         <div className='text-center w-full mt-[5vh]'>
            ...
            <a className="text-white border-[#79072C] border-2 rounded-[10px] p-4 mx-auto font-bold text-md text-center underline" target='_blank' href="/pdf/priceList.pdf">Прайс лист</a>
