      ...
      <div id="form" className={`${s.formBg}  py-[80px] `}>
         <div className="w-full flex  justify-center md:justify-start ">
            <form
               ...
               action=""
            >
               <h2 className="mb-10 text-center text-md text-GradDarkBlue">
               ...
               <input
                  type="text"
                  placeholder="Имя"
                  className="mb-5 border border-GradPurple h-[40px] pl-[25px] md:pl-[50px] md:h-[80px] w-[100%] md:w-full rounded-[20px] bg-white p-2 text-[14px] text-black outline-none md:text-[27px]"
               ...
               >
                  {(inputProps) => (
                     <input
                        type="text"
                        placeholder="Телефон"
                        className={`mb-5 border border-GradPurple h-[40px] pl-[25px] md:pl-[50px]  md:h-[80px] w-[100%] md:w-full rounded-[20px] bg-white p-2 text-[14px] text-black outline-none md:text-[27px] ${phoneError ? "border-red-500" : ""
                           }`}
                        {...inputProps}
                     />
                  )}
               ...
               <Button
                  ...
                  className="mx-auto h-[40px] w-full md:h-[60px] montserrat bg-GradPurple gap-10 md:w-full   text-white shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]"
               >
                  Узнать стоимость
               </Button>
            </form>
