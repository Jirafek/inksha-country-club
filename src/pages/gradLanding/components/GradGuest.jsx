...
const MajGuest = () => {
   ...
   return (
      <div className={`  relative pt-[5vh] pb-[5vh] max-h-[1000px] text-white bg-GradPurple md:pb-[25vh]`}>
         <div className={`text-white font-bold text-center mb-[3vh] text-lg`}>Что говорят наши гости</div>
